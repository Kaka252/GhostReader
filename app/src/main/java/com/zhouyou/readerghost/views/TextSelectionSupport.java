...
public class TextSelectionSupport implements TextSelectionControlListener, View.OnTouchListener, View.OnLongClickListener, DragListener {
    ...
    private TextSelectionSupport.SelectionListener mSelectionListener;
    ...
    private TextSelectionSupport.HandleType mLastTouchedSelectionHandle = TextSelectionSupport.HandleType.UNKNOWN;
    ...
    private Runnable endSelectionModeHandler = new Runnable(){
        public void run() {
            ...
            mLastTouchedSelectionHandle = TextSelectionSupport.HandleType.UNKNOWN;
    ...
    public void setSelectionListener(TextSelectionSupport.SelectionListener listener) {
    ...
    public void onDragEnd() {
        mActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mLastTouchedSelectionHandle == TextSelectionSupport.HandleType.START && startX > 0 && startY > 0){
                ...
                else if (mLastTouchedSelectionHandle == TextSelectionSupport.HandleType.END && endX > 0 && endY > 0){
    ...
    private void createSelectionLayer(Context context){
        ...
        mSelectionDragLayer = (DragLayer)inflater.inflate(com.bossturban.webviewmarker.R.layout.selection_drag_layer, null);
        ...
        mStartSelectionHandle = (ImageView)mSelectionDragLayer.findViewById(com.bossturban.webviewmarker.R.id.startHandle);
        mStartSelectionHandle.setTag(TextSelectionSupport.HandleType.START);
        mEndSelectionHandle = (ImageView)mSelectionDragLayer.findViewById(com.bossturban.webviewmarker.R.id.endHandle);
        mEndSelectionHandle.setTag(TextSelectionSupport.HandleType.END);
        final View.OnTouchListener handleTouchListener = new View.OnTouchListener(){
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    mLastTouchedSelectionHandle = (TextSelectionSupport.HandleType)v.getTag();
                }
                return handledHere;
            }
        };
